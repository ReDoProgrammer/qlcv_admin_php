			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Tên viết tắt</label>
							<input type="text" name="viettat" class="form-control form-control-sm" required value="<?php echo isset($viettat) ? $viettat : '' ?>">
						</div>
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option></option>
									<?php 
                                  	$user_type = $conn->query("SELECT * FROM user_type order by id ");
                                  	while($row= $user_type->fetch_assoc()):
                                  	?>
                                  	<option value="<?php echo $row['id'] ?>" <?php echo isset($type) && $type == $row['id'] ? "selected" : '' ?>><?php echo ucwords($row['name_ut']) ?></option>
                                  	<?php endwhile; ?>
							</select>
						</div>
						<?php else: ?>
