				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<p><b><?php echo date("G:i", strtotime($row['start_date'])) ?></b></p>
								<p class="truncate"><?php echo date("d/m/Y", strtotime($row['start_date'])) ?></p>
							</td>
							<td>
								<p><b><?php echo date("G:i", strtotime($row['end_date'])) ?></b></p>
								<p><?php echo date("d/m/Y", strtotime($row['end_date'])) ?></p>
							</td>
							<td class="text-center">
								<span class='<?php echo $row['color_sttj']; ?>'></span>

								<?php
								$sttj = $conn->query("SELECT * from status_job where id=" . $row['status']);
								while ($rowst = $sttj->fetch_assoc()) :
								?>
									<span class='<?php echo $rowst['color_sttj'] ?>'></span>
								<?php
								endwhile;
								?>
							</td>
