              ...
              <table class="table m-0 table-hover">
                ...
                $row['status'] = 4;
                  ...
                  <tr>
                      ...
                      <td>
                          <?php
						    $prkh = $conn->query("SELECT concat(lastname,' ',firstname) as name FROM custom where id = {$row['idkh']}");
						    while($rowkh= $prkh->fetch_assoc()):
						    ?>
							<p><b><?php echo ucwords($rowkh['name']) ?></b></p>
							<?php endwhile; ?>
                      </td>
                      <td>
                          <a>
                          ...
                          <br>
                          <small>
                              Time out: <?php echo date("Y-m-d",strtotime($row['end_date'])) ?>
                          </small>
                      </td>
